    ...
    >
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-background px-4 py-3 text-base sm:text-sm transition-colors focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:opacity-50"
      ...
      <div>
        ...
        <textarea
          ...
          disabled={status === "submitting"}
          rows={8}
          className="w-full rounded-lg border border-border bg-background px-4 py-3 text-base sm:text-sm transition-colors focus:border-primary focus:ring-2 focus:ring-primary/20 resize-y disabled:opacity-50"
