    ...
    <header className="relative pt-28 pb-20 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div className="container px-4 relative z-10">
        ...
        <div className="max-w-4xl">
          <motion.p
            {...fade(0.05)}
            className="font-mono text-xs text-muted-foreground tracking-wider mb-6"
          >
            day log · platform team · 2025 → ongoing · phosphor P1 · green
          </motion.p>

          <motion.div {...fade(0.1)} className="flex items-baseline gap-4 font-mono">
          ...
          <motion.div {...fade(0.15)} className="border-t border-border/60 mt-4 pt-6">
